...
### 核心交互
- 🔍 **双击防误触激活**：默认轻点一次「左 Option」布防，450ms 内第二次按住，鼠标周围浮现放大圈，松开即消失
...
| 操作 | 快捷键 |
|---|---|
| 激活放大镜 | **左 Option (⌥)** 轻点一次，再在 450ms 内第二次按住 |
| 切换形状 | 默认未设置（建议设为 ⌃⌥S）|
| 打开偏好设置 | 菜单栏 🔍 → 偏好设置 |
...
- **激活放大镜**：点击输入框 → 按一下你要的修饰键（⌥ / ⇧ / ⌃ / ⌘ / Fn）→ 完成。左 Option 是“双击后按住”防误触模式；其他修饰键保持按住-放开式交互
